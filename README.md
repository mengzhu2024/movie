...
咨询V：bishe688
# 演示视频：https://pan.baidu.com/s/1wn9udFwbX_AFzbK6fcLpSw?pwd=z4gq
# 功能详情：
## 登录注册
...
数据统计：查看平台数据统计，包括注册用户数、上映电影个数、订单个数、累计成交金额、电影售票个数趋势图、售票金额趋势图、电影票房排行榜。
![在这里插入图片描述](images/img_7.png)
## 用户端功能设计
